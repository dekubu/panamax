...
class CliAccessoryTest < CliTestCase
  test "boot" do
    Pnmx::Cli::Accessory.any_instance.expects(:directories).with("mysql")
    Pnmx::Cli::Accessory.any_instance.expects(:upload).with("mysql")
  ...
  test "boot all" do
    Pnmx::Cli::Accessory.any_instance.expects(:directories).with("mysql")
    Pnmx::Cli::Accessory.any_instance.expects(:upload).with("mysql")
    Pnmx::Cli::Accessory.any_instance.expects(:directories).with("redis")
    Pnmx::Cli::Accessory.any_instance.expects(:upload).with("redis")
  ...
  test "reboot" do
    Pnmx::Cli::Accessory.any_instance.expects(:stop).with("mysql")
    Pnmx::Cli::Accessory.any_instance.expects(:remove_container).with("mysql")
    Pnmx::Cli::Accessory.any_instance.expects(:boot).with("mysql")
  ...
  test "restart" do
    Pnmx::Cli::Accessory.any_instance.expects(:stop).with("mysql")
    Pnmx::Cli::Accessory.any_instance.expects(:start).with("mysql")
  ...
  test "remove with confirmation" do
    Pnmx::Cli::Accessory.any_instance.expects(:stop).with("mysql")
    Pnmx::Cli::Accessory.any_instance.expects(:remove_container).with("mysql")
    Pnmx::Cli::Accessory.any_instance.expects(:remove_image).with("mysql")
    Pnmx::Cli::Accessory.any_instance.expects(:remove_service_directory).with("mysql")
  ...
  test "remove all with confirmation" do
    ...
    Pnmx::Cli::Accessory.any_instance.expects(:remove_image).with("mysql")
    Pnmx::Cli::Accessory.any_instance.expects(:remove_service_directory).with("mysql")
    Pnmx::Cli::Accessory.any_instance.expects(:stop).with("redis")
    Pnmx::Cli::Accessory.any_instance.expects(:remove_container).with("redis")
    Pnmx::Cli::Accessory.any_instance.expects(:remove_image).with("redis")
    Pnmx::Cli::Accessory.any_instance.expects(:remove_service_directory).with("redis")
  ...
  private
    def run_command(*command)
      stdouted { Pnmx::Cli::Accessory.start([*command, "-c", "test/fixtures/deploy_with_accessories.yml"]) }
    end
end
