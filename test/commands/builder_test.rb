...
class CommandsBuilderTest < ActiveSupport::TestCase
  ...
  test "target multiarch by default" do
    ...
    assert_equal \
      "docker buildx build --push --platform linux/amd64,linux/arm64 --builder pnmx-app-multiarch -t dhh/app:123 -t dhh/app:latest --cache-to type=gha --cache-from type=gha --label service=\"app\" --file Dockerfile .",
      builder.push.join(" ")
  end
  ...
  test "target multiarch remote when local and remote is set" do
    ...
    assert_equal \
      "docker buildx build --push --platform linux/amd64,linux/arm64 --builder pnmx-app-multiarch-remote -t dhh/app:123 -t dhh/app:latest --cache-to type=gha --cache-from type=gha --label service=\"app\" --file Dockerfile .",
      builder.push.join(" ")
  end
  ...
  test "target native remote when only remote is set" do
    ...
    assert_equal \
      "docker buildx build --push --platform linux/amd64 --builder pnmx-app-native-remote -t dhh/app:123 -t dhh/app:latest --cache-to type=gha --cache-from type=gha --label service=\"app\" --file Dockerfile .",
      builder.push.join(" ")
  end
  ...
  test "missing dockerfile" do
    ...
    builder = new_builder_command(builder: { "dockerfile" => "Dockerfile.xyz" })
    assert_raises(Pnmx::Commands::Builder::Base::BuilderError) do
      builder.target.build_options.join(" ")
    end
  end
  ...
  test "build context" do
    ...
    assert_equal \
      "docker buildx build --push --platform linux/amd64,linux/arm64 --builder pnmx-app-multiarch -t dhh/app:123 -t dhh/app:latest --label service=\"app\" --file Dockerfile ..",
      builder.push.join(" ")
  end
  ...
  test "multiarch push with build args" do
    builder = new_builder_command(builder: { "args" => { "a" => 1, "b" => 2 } })
    assert_equal \
      "docker buildx build --push --platform linux/amd64,linux/arm64 --builder pnmx-app-multiarch -t dhh/app:123 -t dhh/app:latest --label service=\"app\" --build-arg a=\"1\" --build-arg b=\"2\" --file Dockerfile .",
      builder.push.join(" ")
  end
  ...
  private
    def new_builder_command(additional_config = {})
      Pnmx::Commands::Builder.new(Pnmx::Configuration.new(@config.merge(additional_config), version: "123"))
    end
end
