...
class Pnmx::Configuration
  delegate :service, :image, :servers, :env, :labels, :registry, :stop_wait_time, :hooks_path, to: :raw_config, allow_nil: true
  delegate :argumentize, :argumentize_env_with_secrets, :optionize, to: Pnmx::Utils
  ...
  def abbreviated_version
    Pnmx::Utils.abbreviate_version(version)
  end
  ...
  def accessories
    @accessories ||= raw_config.accessories&.keys&.collect { |name| Pnmx::Configuration::Accessory.new(name, config: self) } || []
  end
  ...
  def boot
    Pnmx::Configuration::Boot.new(config: self)
  end
  ...
  def hooks_path
    raw_config.hooks_path || ".pnmx/hooks"
  end

  def builder
    Pnmx::Configuration::Builder.new(config: self)
  end
